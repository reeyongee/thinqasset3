...
export function FlipFeatureCard({ feature, index }: FlipFeatureCardProps) {
  ...
  return (
    <div
      className={`feature-card-wrapper relative w-full ${zClass} ${
        index === 2
    ...
    >
      <div className="feature-flip-card h-[440px] w-full min-[810px]:h-[460px] min-[1200px]:w-[376px]">
        <div className="feature-flip-inner relative h-full w-full">
          <div className="feature-flip-back absolute inset-0">
            <div className="h-full overflow-hidden rounded-lg border border-[color:var(--token-btn-border)] bg-token-surface">
              <OptimusCardBack />
            </div>
          </div>

          <div className="feature-flip-front absolute inset-0">
            <div className="flex h-full flex-col overflow-hidden rounded-lg border border-[color:var(--token-btn-border)] bg-token-surface">
              <div className="feature-card-visual relative min-h-0 flex-1 overflow-hidden max-[809px]:h-[310px] max-[809px]:flex-none">

...
const GAUGE_TRACK =
  "M 20 119.99999999999999 A 100 100 0 0 1 220 119.99999999999999";
const GAUGE_PIVOT = { x: 120, y: 120 };
const NEEDLE_PATH =
      ...
      <div className="relative aspect-[240/140] w-[85%] max-w-[304px]">
        <svg viewBox="0 0 240 140" className="h-full w-full" aria-hidden>
          ...
          <g
            ...
            transform={`rotate(45, ${GAUGE_PIVOT.x}, ${GAUGE_PIVOT.y})`}
          >
            <g
              transform={`translate(${GAUGE_PIVOT.x - 7.455}, ${GAUGE_PIVOT.y - 80})`}
            >

...
const ORB_DELAYS = ["0s", "-1.05s", "-2.1s"] as const;
...
export function OrionOrbs() {
  return (
    <div className="feature-orion-visual relative flex h-full w-full items-center justify-center overflow-visible">
      ...
      <div className="feature-orion-badge absolute top-1/2 left-1/2 flex aspect-square min-h-[88px] min-w-[88px] -translate-x-1/2 -translate-y-1/2 items-center justify-center gap-2 rounded-full border border-token-border bg-token-surface px-4 min-[810px]:min-h-[100px] min-[810px]:min-w-[100px]">

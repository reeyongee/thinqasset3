...
const ROUTE_OVERRIDES: Record<string, SiteChromeConfig> = {
  ...
  "/our-team": { chrome: true, progressiveBlur: false },
  "/our-board": { chrome: true, progressiveBlur: false },
  "/our-independent-directors": { chrome: true, progressiveBlur: false },
  "/independent-directors": { chrome: true, progressiveBlur: false },
  "/board-and-governance": { chrome: true, progressiveBlur: false },
  "/board": { chrome: true, progressiveBlur: false },
  "/test-playground": { chrome: true, progressiveBlur: false },
  "/test-playground/independent-directors": { chrome: true, progressiveBlur: false },
  "/test-playground/board": { chrome: true, progressiveBlur: false },
